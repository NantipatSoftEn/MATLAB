...
function xbar_Callback(hObject, eventdata, handles)
% hObject    handle to xbar (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of xbar as text
%        str2double(get(hObject,'String')) returns contents of xbar as a double


% --- Executes during object creation, after setting all properties.
function xbar_CreateFcn(hObject, eventdata, handles)
% hObject    handle to xbar (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
